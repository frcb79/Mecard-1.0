...
import { 
  ...
  X, Layers, Globe, Hash, Database, RefreshCw, Info, BrainCircuit, 
...
// ==========================================
// 4. PANEL DE DETALLE DE INSTITUCIÓN
// ==========================================
...
// ==========================================
// 5. COMPONENTE PRINCIPAL (GATEWAY)
// ==========================================
                ...
                <div className="space-y-12 max-w-4xl">
                    ...
                    <div className="bg-slate-900 rounded-[64px] p-16 text-white relative overflow-hidden shadow-2xl">
                        ...
                        <div className="relative z-10 space-y-8">
                            <p className="text-indigo-400 font-black uppercase text-[11px] tracking-widest flex items-center gap-3"><Sparkles size={16}/> Gemini Pro 2.0 Strategic Analyst</p>
                            <div className="min-h-[250px] text-xl font-medium leading-relaxed text-indigo-100/90 whitespace-pre-wrap">
                                {loadingAi ? (
                                    <div className="flex flex-col items-center gap-6 py-20 animate-pulse">
                                      ...
                                      <p className="font-black text-xs uppercase tracking-[4px]">Escaneando infraestructura...</p>
                                    </div>
                                ) : aiAudit || "Ejecuta una auditoría para detectar anomalías o riesgos financieros."}
                            </div>
                            <Button onClick={handleGenerateAudit} className="bg-indigo-600 px-12 py-8 rounded-[36px] text-[12px] uppercase font-black">Auditar Red</Button>
                        </div>
                    </div>
                </div>
             )}
