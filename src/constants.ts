...
export const MOCK_SCHOOL_FEES: SchoolFee[] = [
  { id: 'fee_01', schoolId: 'mx_01', name: 'Colegiatura Mensual', description: 'Pago mensual de colegiatura', type: SchoolFeeType.TUITION, amount: 8500, recurrence: FeeRecurrence.MONTHLY, dueDay: 5, appliesTo: { all: true }, lateFeePercent: 5, graceDays: 3, earlyPayDiscount: 3, earlyPayDaysBefore: 5, allowPaymentPlan: false, schoolYear: '2025-2026', isActive: true, createdAt: '2026-01-01' },
  { id: 'fee_02', schoolId: 'mx_01', name: 'Inscripción 2026-2027', description: 'Cuota de inscripción anual', type: SchoolFeeType.ENROLLMENT, amount: 15000, recurrence: FeeRecurrence.ANNUAL, dueDay: 15, appliesTo: { all: true }, allowPaymentPlan: true, maxInstallments: 3, schoolYear: '2025-2026', isActive: true, createdAt: '2026-01-01' },
  { id: 'fee_03', schoolId: 'mx_01', name: 'Uniforme Completo', description: 'Kit de uniformes (diario + deportivo)', type: SchoolFeeType.UNIFORM, amount: 3200, recurrence: FeeRecurrence.ONE_TIME, dueDay: 10, appliesTo: { all: false, grades: ['1° Primaria'] }, allowPaymentPlan: true, maxInstallments: 2, schoolYear: '2025-2026', isActive: true, createdAt: '2026-01-15' },
  { id: 'fee_04', schoolId: 'mx_01', name: 'Seguro Escolar', description: 'Seguro de accidentes y cobertura médica', type: SchoolFeeType.INSURANCE, amount: 1800, recurrence: FeeRecurrence.ANNUAL, dueDay: 20, appliesTo: { all: true }, schoolYear: '2025-2026', isActive: true, createdAt: '2026-01-01' },
  { id: 'fee_05', schoolId: 'mx_01', name: 'Material Didáctico', description: 'Paquete de material y libros del semestre', type: SchoolFeeType.MATERIAL, amount: 2500, recurrence: FeeRecurrence.SEMESTER, dueDay: 1, appliesTo: { all: true }, allowPaymentPlan: true, maxInstallments: 2, schoolYear: '2025-2026', isActive: false, createdAt: '2026-01-01' },
];

export const MOCK_PARENT_PAYMENTS: ParentPayment[] = [
  { id: 'pay_01', feeId: 'fee_01', feeName: 'Colegiatura Enero', parentId: 'parent_01', studentId: '2024001', studentName: 'Santiago Gonzalez', amount: 8500, originalAmount: 8500, status: ParentPaymentStatus.PAID, dueDate: '2026-01-05', paidAt: '2026-01-03', paidAmount: 8500, paymentMethod: 'SPEI', referenceNumber: 'REF-20260103-001', earlyPayDiscountApplied: true, earlyPayDiscountAmount: 0 },
  { id: 'pay_02', feeId: 'fee_01', feeName: 'Colegiatura Febrero', parentId: 'parent_01', studentId: '2024001', studentName: 'Santiago Gonzalez', amount: 8500, originalAmount: 8500, status: ParentPaymentStatus.PAID, dueDate: '2026-02-05', paidAt: '2026-02-04', paidAmount: 8500, paymentMethod: 'SPEI', referenceNumber: 'REF-20260204-001' },
  { id: 'pay_03', feeId: 'fee_01', feeName: 'Colegiatura Marzo', parentId: 'parent_01', studentId: '2024001', studentName: 'Santiago Gonzalez', amount: 8500, originalAmount: 8500, status: ParentPaymentStatus.PENDING, dueDate: '2026-03-05' },
  { id: 'pay_04', feeId: 'fee_02', feeName: 'Inscripción 2026-2027', parentId: 'parent_01', studentId: '2024001', studentName: 'Santiago Gonzalez', amount: 15000, originalAmount: 15000, status: ParentPaymentStatus.PENDING, dueDate: '2026-06-15' },
  { id: 'pay_05', feeId: 'fee_04', feeName: 'Seguro Escolar', parentId: 'parent_01', studentId: '2024001', studentName: 'Santiago Gonzalez', amount: 1800, originalAmount: 1800, status: ParentPaymentStatus.PAID, dueDate: '2026-01-20', paidAt: '2026-01-18', paidAmount: 1800, paymentMethod: 'CARD' },
  { id: 'pay_06', feeId: 'fee_01', feeName: 'Colegiatura Enero', parentId: 'parent_02', studentId: '2024002', studentName: 'Valentina Torres', amount: 6800, originalAmount: 8500, scholarshipId: 'sch_01', scholarshipDiscount: 1700, status: ParentPaymentStatus.PAID, dueDate: '2026-01-05', paidAt: '2026-01-05', paidAmount: 6800, paymentMethod: 'SPEI', referenceNumber: 'REF-20260105-002' },
  { id: 'pay_07', feeId: 'fee_01', feeName: 'Colegiatura Febrero', parentId: 'parent_02', studentId: '2024002', studentName: 'Valentina Torres', amount: 7225, originalAmount: 6800, scholarshipId: 'sch_01', scholarshipDiscount: 1700, lateFeeApplied: true, lateFeeAmount: 425, status: ParentPaymentStatus.OVERDUE, dueDate: '2026-02-05' },
  { id: 'pay_08', feeId: 'fee_01', feeName: 'Colegiatura Marzo', parentId: 'parent_02', studentId: '2024002', studentName: 'Valentina Torres', amount: 6800, originalAmount: 8500, scholarshipId: 'sch_01', scholarshipDiscount: 1700, status: ParentPaymentStatus.PENDING, dueDate: '2026-03-05' },
  { id: 'pay_09', feeId: 'fee_03', feeName: 'Uniforme Completo', parentId: 'parent_03', studentId: '2024003', studentName: 'Mateo Ramírez', amount: 3200, originalAmount: 3200, status: ParentPaymentStatus.PARTIAL, dueDate: '2026-02-10', paidAmount: 1600, paymentMethod: 'CASH', paymentPlanId: 'plan_01', installmentNumber: 1 },
  { id: 'pay_10', feeId: 'fee_01', feeName: 'Colegiatura Enero', parentId: 'parent_03', studentId: '2024003', studentName: 'Mateo Ramírez', amount: 8500, originalAmount: 8500, status: ParentPaymentStatus.PAID, dueDate: '2026-01-05', paidAt: '2026-01-04', paidAmount: 8500, paymentMethod: 'SPEI', referenceNumber: 'REF-20260104-003' },
  { id: 'pay_11', feeId: 'fee_01', feeName: 'Colegiatura Febrero', parentId: 'parent_03', studentId: '2024003', studentName: 'Mateo Ramírez', amount: 8500, originalAmount: 8500, status: ParentPaymentStatus.PAID, dueDate: '2026-02-05', paidAt: '2026-02-03', paidAmount: 8500, paymentMethod: 'OXXO', referenceNumber: 'REF-20260203-003' },
  { id: 'pay_12', feeId: 'fee_01', feeName: 'Colegiatura Marzo', parentId: 'parent_03', studentId: '2024003', studentName: 'Mateo Ramírez', amount: 8500, originalAmount: 8500, status: ParentPaymentStatus.PENDING, dueDate: '2026-03-05' },
];
...
export const MOCK_SCHOLARSHIPS: Scholarship[] = [
  { id: 'sch_01', schoolId: 'mx_01', studentId: '2024002', studentName: 'Valentina Torres', type: ScholarshipType.ACADEMIC, name: 'Beca Excelencia Académica', discountType: DiscountType.PERCENTAGE, discountValue: 20, appliesToFeeTypes: [SchoolFeeType.TUITION], validFrom: '2025-08-01', validUntil: '2026-07-31', approvedBy: 'Dirección', notes: 'Promedio 9.8 en ciclo anterior', isActive: true, createdAt: '2025-07-15' },
  { id: 'sch_02', schoolId: 'mx_01', studentId: '2024004', studentName: 'Isabella Morales', type: ScholarshipType.SIBLING, name: 'Descuento Hermanos', discountType: DiscountType.PERCENTAGE, discountValue: 10, appliesToFeeTypes: [SchoolFeeType.TUITION, SchoolFeeType.ENROLLMENT], validFrom: '2025-08-01', validUntil: '2026-07-31', approvedBy: 'Administración', notes: '2do hijo inscrito', isActive: true, createdAt: '2025-07-20' },
  { id: 'sch_03', schoolId: 'mx_01', studentId: '2024005', studentName: 'Diego Hernández', type: ScholarshipType.SPORTS, name: 'Beca Deportiva Fútbol', discountType: DiscountType.FIXED_AMOUNT, discountValue: 2000, appliesToFeeTypes: [SchoolFeeType.TUITION], validFrom: '2025-08-01', validUntil: '2026-07-31', approvedBy: 'Coord. Deportiva', notes: 'Seleccionado estatal sub-12', isActive: true, createdAt: '2025-08-01' },
  { id: 'sch_04', schoolId: 'mx_01', studentId: '2024006', studentName: 'Camila Vargas', type: ScholarshipType.NEED_BASED, name: 'Apoyo Socioeconómico', discountType: DiscountType.PERCENTAGE, discountValue: 50, appliesToFeeTypes: [], validFrom: '2025-08-01', validUntil: '2026-07-31', approvedBy: 'Comité de Becas', notes: 'Estudio socioeconómico aprobado', isActive: true, createdAt: '2025-07-25' },
  { id: 'sch_05', schoolId: 'mx_01', studentId: '2024007', studentName: 'Emiliano Ruiz', type: ScholarshipType.STAFF, name: 'Beca Hijos de Personal', discountType: DiscountType.PERCENTAGE, discountValue: 100, appliesToFeeTypes: [SchoolFeeType.TUITION], validFrom: '2025-08-01', validUntil: '2026-07-31', approvedBy: 'Dirección General', notes: 'Hijo de docente', isActive: true, createdAt: '2025-07-10' },
];
...
export const MOCK_PAYMENT_PLANS: PaymentPlan[] = [
  { id: 'plan_01', schoolId: 'mx_01', parentId: 'parent_03', studentId: '2024003', studentName: 'Mateo Ramírez', paymentId: 'pay_09', feeName: 'Uniforme Completo', totalAmount: 3200, installments: 2, installmentAmount: 1600, paidInstallments: 1, nextDueDate: '2026-03-10', status: PaymentPlanStatus.ACTIVE, createdAt: '2026-02-10', notes: 'Autorizado por administración' },
  { id: 'plan_02', schoolId: 'mx_01', parentId: 'parent_02', studentId: '2024002', studentName: 'Valentina Torres', paymentId: 'pay_04_val', feeName: 'Inscripción 2026-2027', totalAmount: 12000, installments: 3, installmentAmount: 4000, paidInstallments: 0, nextDueDate: '2026-04-15', status: PaymentPlanStatus.ACTIVE, createdAt: '2026-02-20', notes: 'Plan a 3 meses con beca hermanos' },
  { id: 'plan_03', schoolId: 'mx_01', parentId: 'parent_01', studentId: '2024001', studentName: 'Santiago Gonzalez', paymentId: 'pay_04', feeName: 'Inscripción 2026-2027', totalAmount: 15000, installments: 3, installmentAmount: 5000, paidInstallments: 0, nextDueDate: '2026-04-15', status: PaymentPlanStatus.ACTIVE, createdAt: '2026-02-22' },
];

// ============================================
// FEE REMINDERS / RECORDATORIOS DE COBRO
// ============================================

export const MOCK_FEE_REMINDERS: FeeReminder[] = [
  { id: 'rem_01', schoolId: 'mx_01', name: 'Recordatorio 7 días antes', schedule: FeeReminderSchedule.DAYS_BEFORE_7, feeTypes: [SchoolFeeType.TUITION], channel: 'notification', messageTemplate: 'Recordatorio: Su pago de {concepto} por ${monto} vence el {fecha}. Realice su pago a tiempo para evitar recargos.', isActive: true, lastSent: '2026-02-26', sentCount: 360, createdAt: '2026-01-01' },
  { id: 'rem_02', schoolId: 'mx_01', name: 'Recordatorio 3 días antes', schedule: FeeReminderSchedule.DAYS_BEFORE_3, feeTypes: [SchoolFeeType.TUITION], channel: 'both', messageTemplate: '⚠️ Su pago de {concepto} vence en 3 días (${monto}). Evite recargos del {recargo}%.', isActive: true, lastSent: '2026-03-02', sentCount: 355, createdAt: '2026-01-01' },
  { id: 'rem_03', schoolId: 'mx_01', name: 'Aviso de vencimiento', schedule: FeeReminderSchedule.ON_DUE_DATE, feeTypes: [], channel: 'both', messageTemplate: '🔴 Hoy vence su pago de {concepto} por ${monto}. Realice su pago hoy para evitar recargos automáticos.', isActive: true, lastSent: '2026-03-05', sentCount: 118, createdAt: '2026-01-01' },
  { id: 'rem_04', schoolId: 'mx_01', name: 'Notificación de recargo aplicado', schedule: FeeReminderSchedule.DAYS_AFTER_1, feeTypes: [SchoolFeeType.TUITION], channel: 'notification', messageTemplate: 'Se ha aplicado un recargo del {recargo}% a su pago de {concepto}. Nuevo monto: ${monto}. Regularice su situación.', isActive: true, lastSent: '2026-02-06', sentCount: 24, createdAt: '2026-01-01' },
  { id: 'rem_05', schoolId: 'mx_01', name: 'Recordatorio semanal vencidos', schedule: FeeReminderSchedule.WEEKLY_OVERDUE, feeTypes: [], channel: 'both', messageTemplate: '📌 Tiene {cantidad} pago(s) vencido(s) por un total de ${monto}. Acérquese a administración para regularizar su situación.', isActive: false, sentCount: 0, createdAt: '2026-01-15' },
];
